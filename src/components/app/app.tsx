            ...
            <div className={styles.MainNav__wrapper}>
              <nav className={styles.MainNav__content} aria-label="Global">
                <div className={styles.MainNav__logoWrapper}>
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <Link to="/"> 
                      ...
                      <img className="h-8 w-auto sm:h-10" alt="" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" />
                    </Link>
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                  <Link to="/" className="font-medium text-gray-500 hover:text-gray-900">Product</Link>
    
                  <Link to="/" className="font-medium text-gray-500 hover:text-gray-900">Features</Link>
    
                  <Link to="/" className="font-medium text-gray-500 hover:text-gray-900">Marketplace</Link>
    
                  <Link to="/" className="font-medium text-gray-500 hover:text-gray-900">Company</Link>
    
                  <Link to="/" className="font-medium text-indigo-600 hover:text-indigo-500">Log in</Link>
                </div>
              </nav>
            </div>
              ...
              <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                  <div className="px-2 pt-2 pb-3 space-y-1" role="none">
                    ...
                    <Link to="/Dashboard" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Features</Link>
    
                    <Link to="/Dashboard" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Marketplace</Link>
    
                    <Link to="/Dashboard" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">Company</Link>
